...
var _setPrototypeOf = __webpack_require__(571);

var _setPrototypeOf2 = _interopRequireDefault(_setPrototypeOf);

var _create = __webpack_require__(575);
...
var aFunction = __webpack_require__(543);
...
var _iterator = __webpack_require__(547);
...
var redefine = __webpack_require__(216);
var hide = __webpack_require__(24);
var has = __webpack_require__(20);
var Iterators = __webpack_require__(93);
var $iterCreate = __webpack_require__(551);
...
var arrayIndexOf = __webpack_require__(553)(false);
var IE_PROTO = __webpack_require__(85)('IE_PROTO');
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(28),p=__webpack_require__(41);__webpack_require__(18);var r=__webpack_require__(14);
...
var objectAssign$1 = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stylis__ = __webpack_require__(536);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stylis___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_stylis__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_is_function__ = __webpack_require__(537);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_hoist_non_react_statics__ = __webpack_require__(538);
...
var _promotions = __webpack_require__(578);
...
// true  -> Array#includes
var toIObject = __webpack_require__(26);
var toLength = __webpack_require__(554);
var toAbsoluteIndex = __webpack_require__(555);
...
var addToUnscopables = __webpack_require__(559);
var step = __webpack_require__(560);
var Iterators = __webpack_require__(93);
var toIObject = __webpack_require__(26);
...
var $export = __webpack_require__(21);
var redefine = __webpack_require__(216);
var META = __webpack_require__(564).KEY;
var $fails = __webpack_require__(25);
...
var gOPNExt = __webpack_require__(567);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(211)(Function.call, __webpack_require__(221).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _taggedTemplateLiteral2 = __webpack_require__(904);
...
var _selectbox = __webpack_require__(579);

var _styledComponents = __webpack_require__(533);
...
var PromoHeading = _styledComponents2.default.h2(_templateObject2);

var ItemCountStyled = _styledComponents2.default.span(_templateObject3);

var StyledSpan = _styledComponents2.default.span(_templateObject4);

var FlexContainer = _styledComponents2.default.div(_templateObject5);

var HeadingFlexContainer = FlexContainer.extend(_templateObject6);

var SortFlexContainer = FlexContainer.extend(_templateObject7);

var SelectBoxContainer = FlexContainer.extend(_templateObject8);

var SortingRadioButton = _styledComponents2.default.div(_templateObject9, function (props) {
    return props.isRadioActive && 'border-bottom: 1px solid #03b4ee; color: #000;';
});

var SortRadio = function (_React$Component) {
    (0, _inherits3.default)(SortRadio, _React$Component);

    function SortRadio(props) {
        (0, _classCallCheck3.default)(this, SortRadio);

        var _this = (0, _possibleConstructorReturn3.default)(this, (SortRadio.__proto__ || (0, _getPrototypeOf2.default)(SortRadio)).call(this, props));
    ...
    (0, _createClass3.default)(SortRadio, [{
        key: "toggleRadio",
        ...
        value: function render() {
            return React.createElement(
                SortingRadioButton,
                { isRadioActive: this.state.isRadioActive,
...
var SortingContainer = function (_React$Component2) {
    (0, _inherits3.default)(SortingContainer, _React$Component2);

    function SortingContainer() {
        (0, _classCallCheck3.default)(this, SortingContainer);
        return (0, _possibleConstructorReturn3.default)(this, (SortingContainer.__proto__ || (0, _getPrototypeOf2.default)(SortingContainer)).call(this));
    }

    (0, _createClass3.default)(SortingContainer, [{
        key: "render",
        value: function render() {
            var isRadioActive = this.props.isRadioActive;
            ...
            return React.createElement(
                ...
                React.createElement(
                    "div",
                    null,
                    React.createElement(SortRadio, { isRadioActive: isRadioActive, content: "\u0412\u0441\u0435 \u0430\u043A\u0446\u0438\u0438", "default": true }),
                    React.createElement(SortRadio, { isRadioActive: isRadioActive, content: "\u041F\u043E\u0434\u0430\u0440\u043E\u043A \u0441 \u043F\u043E\u043A\u0443\u043F\u043A\u043E\u0439" }),
                    React.createElement(SortRadio, { isRadioActive: isRadioActive, content: "\u041A\u043B\u0438\u0435\u043D\u0442\u0441\u043A\u0438\u0435 \u0434\u043D\u0438" })
                ),
                React.createElement(
                    SelectBoxContainer,
                    null,
                    ...
                    React.createElement(_selectbox.Sort, null),
                    React.createElement(_selectbox.Sort, null)
                )
            );
        }
...
var Promotions = exports.Promotions = function (_React$Component3) {
    ...
    function Promotions() {
        ...
        return (0, _possibleConstructorReturn3.default)(this, (Promotions.__proto__ || (0, _getPrototypeOf2.default)(Promotions)).apply(this, arguments));
    }
    ...
    (0, _createClass3.default)(Promotions, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(SortingContainer, null)
            );
        }
    }]);
    return Promotions;
...
var _extends2 = __webpack_require__(580);
...
var StyledSort = _styledComponents2.default.div(_templateObject, function (props) {
    return props.showSort && 'border-top: 1px solid #6a6a6a; border-left: 1px solid #6a6a6a; border-bottom: none; border-right: none;';
});

var SortList = _styledComponents2.default.ul(_templateObject2);

var SortListItem = _styledComponents2.default.li(_templateObject3);
...
var Sort = exports.Sort = function (_React$Component) {
    ...
    function Sort(props) {
        ...
        _this.sorts = [{ code: 1, name: 'Все бренды', selected: false }, { code: 2, name: 'Не все бренды', selected: false }, { code: 3, name: 'В интернет-магазине', selected: false }, { code: 4, name: 'Что-то ещё', selected: true }];

        var currentSort = _this.sorts.filter(function (sortItem) {
            return sortItem.selected;
        });
        _this.state = {
            showSort: false,
            currentSort: (0, _extends3.default)({}, currentSort[0])
        };
        return _this;
    }
    ...
    (0, _createClass3.default)(Sort, [{
        ...
        key: 'clickSortItem',
        value: function clickSortItem(event) {
            this.setState({
                currentSort: (0, _extends3.default)({}, event.target.dataset),
                showSort: false
            });
        ...
        value: function render() {
            ...
            var options = this.sorts.map(function (sortItem, i) {
                return React.createElement(
                    SortListItem,
                    { key: i,
                        'data-code': sortItem.code,
                        'data-name': sortItem.name,
                        onClick: _this2.clickSortItem.bind(_this2) },
                    sortItem.name
                );
            });
            return React.createElement(
                ...
                this.state.showSort ? React.createElement(
                    SortList,
                    { className: 'options animated fadeInUp' },
                    options
                ) : null
            );
        }
...
var _assign = __webpack_require__(581);
...
$export($export.S + $export.F, 'Object', { assign: __webpack_require__(584) });
...
var _defineProperties = __webpack_require__(905);

var _defineProperties2 = _interopRequireDefault(_defineProperties);

var _freeze = __webpack_require__(908);
...
module.exports = { "default": __webpack_require__(906), __esModule: true };
...
$export($export.S + $export.F * !__webpack_require__(23), 'Object', { defineProperties: __webpack_require__(552) });
...
var isObject = __webpack_require__(39);
var meta = __webpack_require__(564).onFreeze;
